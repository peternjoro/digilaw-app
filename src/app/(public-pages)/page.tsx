        ...
        <main className="w-full">
            <section id="here-section" className="container mx-auto py-10">
                <div className="flex w-full md:space-x-5">
                    <div className="flex flex-col w-full md:w-1/2 text-center md:text-left md:justify-center pr-10 md:pr-20 space-y-5">
            ...
            <section id="services-section" className="bg-black py-14">
